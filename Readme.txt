Challenge Mule flow has been designed using an XML editor. Mule CE is embedded in a spring boot application using mule-spring-boot-starter
...
3) Scatter-gather has been used to achieve parallel processing
