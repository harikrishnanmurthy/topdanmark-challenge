...
public class CustomSGAggregationStrategy implements AggregationStrategy, MuleContextAware {
	
	private static final Logger logger = Logger.getLogger(CustomSGAggregationStrategy.class);
